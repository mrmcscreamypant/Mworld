...
export class RawColliderSet {
	...
	coCastCollider(
		...
		max_toi: number,
		stop_at_penetration: boolean
	): RawColliderShapeCastHit | undefined;
	/**
	 * @param {number} handle
	 * @param {RawShape} shape2
...
export class RawDynamicRayCastVehicleController {
	...
	update_vehicle(
		...
		filter_flags: number,
		filter_groups: number | undefined,
...
export class RawKinematicCharacterController {
	...
	computeColliderMovement(
		...
		character_mass: number | undefined,
		filter_flags: number,
		filter_groups: number | undefined,
		filter_predicate: Function
	): void;
...
export class RawPhysicsPipeline {
	...
	step(
		...
		bodies: RawRigidBodySet,
		colliders: RawColliderSet,
		joints: RawImpulseJointSet,
		articulations: RawMultibodyJointSet,
		ccd_solver: RawCCDSolver
	): void;
	/**
	 * @param {RawVector} gravity
	 * @param {RawIntegrationParameters} integrationParameters
	...
	stepWithEvents(
		...
		hookObject: object,
		hookFilterContactPair: Function,
		hookFilterIntersectionPair: Function
	): void;
}
/**
 */
...
export class RawQueryPipeline {
	...
	castRay(
		...
		filter_flags: number,
		filter_groups: number | undefined,
		filter_exclude_collider: number | undefined,
		filter_exclude_rigid_body: number | undefined,
		filter_predicate: Function
	): RawRayColliderHit | undefined;
	/**
	 * @param {RawRigidBodySet} bodies
	 * @param {RawColliderSet} colliders
	 * @param {RawVector} rayOrig
	...
	castRayAndGetNormal(
		...
		filter_exclude_rigid_body: number | undefined,
		filter_predicate: Function
	): RawRayColliderIntersection | undefined;
	/**
	 * @param {RawRigidBodySet} bodies
	 * @param {RawColliderSet} colliders
	 * @param {RawVector} rayOrig
	...
	projectPoint(
		...
		filter_exclude_rigid_body: number | undefined,
		filter_predicate: Function
	): RawPointColliderProjection | undefined;
	/**
	 * @param {RawRigidBodySet} bodies
	 * @param {RawColliderSet} colliders
	 * @param {RawVector} point
...
export class RawRigidBodySet {
	...
	createRigidBody(
		...
		principalAngularInertia: RawVector,
		angularInertiaFrame: RawRotation,
		translationEnabledX: boolean,
		translationEnabledY: boolean,
		translationEnabledZ: boolean,
		rotationEnabledX: boolean,
		rotationEnabledY: boolean,
		rotationEnabledZ: boolean,
		...
		additional_solver_iterations: number
	): number;
	/**
	 * @param {number} handle
	 * @param {RawIslandManager} islands
...
export interface InitOutput {
	...
	readonly rawkinematiccharactercontroller_computeColliderMovement: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawdynamicraycastvehiclecontroller_add_wheel: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawdynamicraycastvehiclecontroller_update_vehicle: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawdynamicraycastvehiclecontroller_set_wheel_chassis_connection_point_cs: (
		a: number,
		b: number,
		c: number
	) => void;
	readonly rawdynamicraycastvehiclecontroller_wheel_suspension_rest_length: (a: number, b: number, c: number) => void;
	readonly rawdynamicraycastvehiclecontroller_set_wheel_suspension_rest_length: (
		a: number,
		b: number,
		c: number
	) => void;
	readonly rawdynamicraycastvehiclecontroller_wheel_max_suspension_travel: (a: number, b: number, c: number) => void;
	readonly rawdynamicraycastvehiclecontroller_set_wheel_max_suspension_travel: (
		a: number,
		b: number,
		c: number
	) => void;
	...
	readonly rawdynamicraycastvehiclecontroller_set_wheel_suspension_compression: (
		a: number,
		b: number,
		c: number
	) => void;
	readonly rawdynamicraycastvehiclecontroller_wheel_suspension_relaxation: (a: number, b: number, c: number) => void;
	readonly rawdynamicraycastvehiclecontroller_set_wheel_suspension_relaxation: (
		a: number,
		b: number,
		c: number
	) => void;
	...
	readonly rawdynamicraycastvehiclecontroller_set_wheel_side_friction_stiffness: (
		a: number,
		b: number,
		c: number
	) => void;
	...
	readonly rawimpulsejointset_jointConfigureMotorVelocity: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawimpulsejointset_jointConfigureMotorPosition: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawimpulsejointset_jointConfigureMotor: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetRotation: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetNextKinematicTranslation: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetNextKinematicRotation: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetAdditionalMassProperties: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetEnabledTranslations: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_rbSetEnabledRotations: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawrigidbodyset_createRigidBody: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_coSetRotationWrtParent: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_coCastShape: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_coCastCollider: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_coCastRayAndGetNormal: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_coSetMassProperties: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawcolliderset_createCollider: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawshape_contactShape: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawshape_castRayAndGetNormal: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawphysicspipeline_step: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawphysicspipeline_stepWithEvents: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_castRay: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_castRayAndGetNormal: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_intersectionsWithRay: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_intersectionWithShape: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_projectPoint: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_projectPointAndGetFeature: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_intersectionsWithPoint: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_castShape: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawquerypipeline_intersectionsWithShape: (
		a: number,
		b: number,
		c: number,
		d: number,
	...
	readonly rawserializationpipeline_serializeAll: (
		a: number,
		b: number,
		c: number,
		d: number,
